...
$filename = (isset($_POST['nomearquivo'])) ? $_POST['nomearquivo'] : '';

if( $testerFile->check_file_uploaded_name($filename) && $testerFile->check_file_uploaded_length($filename)  ) {
	//ok para verificação inicial
	//mover0
	$newLocal = 'gs://mb-cadastro-arquivos/' . $newFileName . $type;
