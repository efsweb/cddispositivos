...
$upload_url = CloudStorageTools::createUploadUrl('/arquivos.php', $options);
?>
...
<html lang="pt-br">
	...
	<body>
		...
		<div class="container-fluid">
			...
			<div class="row">
				...
				<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
					<h2 class="sub-header">Arquivos enviados - <?= $upload_url; ?></h2>
		...
		<div id="upload" class="modal fade" data-backdrop="static">
	        <form id="frmupload12" class="form-horizontal" role="form" action="<?= $upload_url; ?>" enctype="multipart/form-data" method="post">
